...
export type SpmsStatus = 'backlog' | 'todo' | 'in_progress' | 'testing' | 'done' | 'canceled';

export const SPMS_STATUSES: SpmsStatus[] = ['backlog', 'todo', 'in_progress', 'testing', 'done', 'canceled'];
